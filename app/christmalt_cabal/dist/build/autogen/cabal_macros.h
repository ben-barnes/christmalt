...
/* package christmalt-cabal-0.1.0.0 */
#define VERSION_christmalt_cabal "0.1.0.0"
#define MIN_VERSION_christmalt_cabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package http-api-data-0.3.3 */
#define VERSION_http_api_data "0.3.3"
...
/* package http-client-tls-0.3.3 */
#define VERSION_http_client_tls "0.3.3"
...
#define CURRENT_COMPONENT_ID "christmalt-cabal-0.1.0.0"

#define CURRENT_PACKAGE_KEY "christmalt-cabal-0.1.0.0"
